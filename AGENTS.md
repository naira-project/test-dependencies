...
Naira is an open source project building an internal development platform (IDP) that
bridges Software Development and AI Engineering, and helps Platform Engineers lead
their organization to a robust and open AI infrastructure. It leverages
[kcp](https://github.com/kcp-dev/kcp), [Platform Mesh](https://platform-mesh.io/main/)
and [OpenMFP](https://openmfp.org/).

Naira does not implement inferencing, AI gateways and similar features itself; it
